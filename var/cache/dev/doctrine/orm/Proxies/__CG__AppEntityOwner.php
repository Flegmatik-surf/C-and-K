...
class Owner extends \App\Entity\Owner implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'firstname', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'familyName', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'address', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'country', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'rooms', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'imageName', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'imageFile', '' . "\0" . 'App\\Entity\\Owner' . "\0" . 'imageUpdatedAt'];
        }
